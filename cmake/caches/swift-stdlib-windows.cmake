...
# --- libraries to use ---
set(SWIFT_WINDOWS_x86_64_ICU_UC_INCLUDE "${TOOLCHAIN_SOURCE_DIR}/build/icu-59.1-vs2017/include/unicode" CACHE STRING "")
set(SWIFT_WINDOWS_x86_64_ICU_UC "${TOOLCHAIN_SOURCE_DIR}/build/icu-59.1-vs2017/lib64/icuuc.lib" CACHE STRING "")
set(SWIFT_WINDOWS_x86_64_ICU_I18N_INCLUDE "${TOOLCHAIN_SOURCE_DIR}/build/icu-59.1-vs2017/include" CACHE STRING "")
set(SWIFT_WINDOWS_x86_64_ICU_I18N "${TOOLCHAIN_SOURCE_DIR}/build/icu-59.1-vs2017/lib64/icuin.lib" CACHE STRING "" FORCE)
